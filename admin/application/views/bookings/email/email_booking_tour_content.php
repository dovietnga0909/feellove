		...
		<tr>
			<td colspan="2">
				<table cellpadding="0" cellspacing="0" width="100%" style="font-family: Arial; font-size:12px;border-top: 1px solid #7BA0CD;border-left: 1px solid #7BA0CD;empty-cells: show;">
					...
					<tr>
						<td width="150" style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;"><b><?=lang('tour_name')?>:</b></td>
					...
					<tr>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;"><b><?=lang('start_date')?>:</b></td>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;">
					...
					<tr>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;"><b><?=lang('end_date')?>:</b></td>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;">
					...
					<tr>
						...
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;"><b><?=lang('services')?>:</b></td>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;">
							<?=str_replace("\n", "<br>",$services)?>
						</td>
					</tr>
					...
					<tr>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;"><b><?=lang('total_price')?>:</b></td>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;">
							<?=$total_price?>
						</td>
					</tr>
					...
					<tr>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;"><b><?=lang('guest_information')?>:</b></td>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;">
							<?=$guest_information?>
						</td>
					</tr>
					...
					<tr>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;"><b><?=lang('pick_up')?>:</b></td>
						<td style="border-bottom: 1px solid #7BA0CD;border-right: 1px solid #7BA0CD;padding: 4px 4px 4px 4px;">
							<?=$pick_up?>
						</td>
					</tr>
