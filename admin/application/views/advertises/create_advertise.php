...
<form class="form-horizontal" role="form" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="name" placeholder="<?=lang('advertise_name')?>..." name="name" value="<?=set_value('name')?>">
      <?=form_error('name')?>
    </div>
  </div>
    ...
    <div class="col-sm-3">      
      <select class="form-control" id="data_type" name="data_type">
		  ...
		  <?php foreach ($data_types as $key=>$value):?>
		  		<option value="<?=$key?>" <?=set_select('data_type', $key)?>><?=$value?></option>
		  <?php endforeach;?>
	  </select> 
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-8">
    	...
    	<label class="checkbox-inline">
  			<input type="checkbox" id="check_box_<?=$key?>" value="<?=$key?>" <?=set_checkbox('display_on[]',$key)?> name="display_on[]" > <?=$value?>
		</label>
		<?php endforeach;?>
		<br>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="link" placeholder="<?=lang('ad_field_link')?>..." name="link" value="<?=set_value('link')?>">
      <?=form_error('link')?>
    </div>
  </div>
