	...
	<div class="form-group">
		...
		<div class="form-group">
		    <div class="col-xs-offset-2 col-xs-6">
				...
				<a class="btn btn-default mg-left-10" href="<?=site_url('cruises/facilities/'.$cruise['id'])?>" role="button"><?=lang('btn_cancel')?></a>
				<a class="btn btn-danger mg-left-10" onclick="return confirm_delete('<?=lang('confirm_delete')?>')"
					href="<?=site_url('cruises/delete_facility/'.$facility['id'])?>" role="button"><?=lang('btn_delete')?></a>
			</div>
		</div>
	</form>
<?php endif;?>