<div class="well">
	<form class="form-inline" role="form" name="sfrm" method="post" action="<?=site_url().'roles/'?>">
		<div class="form-group">
			<label for="search_name"><?=lang('roles_field_name')?></label>
	  		<br>
			<input type="text" placeholder="<?=lang('list_role_search_holder')?>" class="form-control input-sm" name="search_text"
