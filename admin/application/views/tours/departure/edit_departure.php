<form class="form-horizontal" role="form" method="post">
    ...
    <div class="form-group">
    	...
    	<div class="col-xs-9">
    	     <textarea rows="5" class="form-control" name="service_includes" id="service_includes"><?=set_value('service_includes', $tour_departure['service_includes'])?></textarea>
    	</div>
    </div>
    ...
    <div class="form-group">
    	...
    	<div class="col-xs-9">
    	     <textarea rows="5" class="form-control" name="service_excludes" id="service_excludes"><?=set_value('service_excludes', $tour_departure['service_excludes'])?></textarea>
    	</div>
    </div>
    ...
    <div class="hide" id="group_weekdays">
        ...
        <div class="panel panel-default" style="margin: 30px 0 60px">
        	...
        	<table class="table table-striped">
        		...
        		<tbody>
        		    <?php if(!empty($tour_departure_dates)):?>
    ...
    <div class="form-group hide" id="group_specific_dates">
        ...
        <div class="col-xs-8">
            <textarea class="form-control" rows="3" name="specific_dates" 
                id="specific_dates" placeholder="Ex: <?=date(DATE_FORMAT)?>;<?=date(DATE_FORMAT, strtotime('+3 days'))?>"><?=set_value('specific_dates', $tour_departure['departure_specific_date'])?></textarea>
        </div>
    ...
    <a class="btn btn-default mg-left-10" href="<?=site_url('tours/departure/'.$tour_departure['tour_id'])?>" role="button"><?=lang('btn_cancel')?></a>
