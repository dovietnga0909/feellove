...
<div class="well well-sm">
	  ...
	  <div class="form-group">
	    <label for="accommodation_id"><?=lang('rate_accommodation')?></label>
	  	<br>
		<select class="form-control input-sm" id="accommodation_id" name="accommodation_id">
			<option value=""><?=lang('rate_all_accommodation')?></option>
			
			<?php foreach ($accommodations as $value):?>
				<option value="<?=$value['id']?>" <?=set_select('accommodation_id', $value['id'], isset($search_criteria['accommodation_id']) && $search_criteria['accommodation_id'] == $value['id'])?>><?=$value['name']?></option>
			<?php endforeach;?>
	  ...
	  <div class="form-group pull-right">
		  ...
		  <div class="input-group">
		      ...
		      <input type="text" class="form-control input-sm" readonly="readonly" 
		          value="<?=$search_criteria['start_date']?> &divide; <?=$search_criteria['end_date']?>"
		          style="height: 29px">
		      <span class="input-group-btn">
