...
<ul class="sortable grid">
	...
	<li>
		<div class="form-group thumb" id="thumb_<?=$key?>">
			<div class="thumbnail"><img class="h-photo" src="<?=get_static_resources('/images/tours/uploads/'.$photo['name'])?>"></div>
...
<div class="row">
	<div class="col-xs-8">
		<div class="form-group">
			...
			<a class="btn btn-default mg-left-10" href="<?=site_url('tours/photo_upload/'.$tour['id'].'?action=cancel')?>" role="button"><?=lang('btn_cancel')?></a>
		</div>
	</div>
</div>
</form>
