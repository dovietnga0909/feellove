...
<div class="bpv-search-overview">
	...
	<div class="content clearfix">
		...
		<div class="row margin-bottom-10">
			...
			<div class="col-xs-8">
				<span class='selected-departure-date'><?=format_bpv_date($search_criteria['Depart'], DATE_FORMAT, true)?></span>
			</div>
		</div>
		...
		<div class="row margin-bottom-10">
			...
			<div class="col-xs-8">
				<span class='selected-return-date'><?=format_bpv_date($search_criteria['Return'], DATE_FORMAT, true)?></span>
			</div>
		</div>
