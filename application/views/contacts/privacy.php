	...
	<div class="bpv-col-right">
		<div class="bpv-contact-container">
			<div class="content">
				...
				<p>
					Chính sách an toàn và bảo mật này áp dụng cho tất cả các dịch vụ của chúng tôi (dù được lấy từ hay có sẵn trực tuyến, hoặc thông qua bất kỳ diễn đàn hay thiết bị nào khác (từ đây về sau được quy chung thành "trang web")).
				</p>
				
				<h5 class="bpv-color-title"><b>Thông Tin Chúng Tôi Thu Thập:</b></h5>
				<p>
				...
				<h5 class="bpv-color-title"><b>Bảo Vệ Dữ Liệu Cá Nhân Của Quý khách:</b></h5>	
				<p>
				...
				<h5 class="bpv-color-title"><b>Cách Thức Chúng Tôi Sử Dụng Thông Tin Chúng Tôi Thu Thập Được:</b></h5>
				<p>
					Chúng tôi sử dụng Dữ Liệu Cá nhân và thông tin khác được thu thập thông qua Website để đăng ký quý khách với Website, để cung cấp cho quý khách những sản phẩm và dịch vụ theo yêu cầu, để xây dựng các tính năng làm cho dịch vụ trên Website dễ sử dụng hơn, và để liên hệ với quý khách về những dịch vụ này. Điều này bao gồm các yêu cầu mua nhanh hơn, việc hỗ trợ khách hàng tốt hơn và việc thông báo kịp thời các dịch vụ mới và ưu đãi đặc biệt. Thỉnh thoảng, Best Price Vietnam có thể liên hệ với quý khách để hỏi phản hồi về việc sử dụng Website, nhằm giúp chúng tôi nâng cao chất lượng Website, hoặc để cung cấp những chương trình tiết kiệm hoặc khuyến mại đặc biệt cho quý khách với tư cách người dùng Website nếu quý khách đã chỉ ra là quý vị đồng ý nhận những thông tin như vậy. Nếu quý vị không thích nhận thông báo về các chương trình tiết kiệm hoặc khuyến mại đặc biệt, quý khách có thể chọn không nhận bằng cách hồi âm cho Best Price Vietnam.
				</p>
				
				<h5 class="bpv-color-title"><b>Chia Sẻ Dữ Liệu Cá Nhân Của Quý Khách:</b></h5>
				<p>Best Price Vietnam có thể chia sẻ Dữ Liệu Cá Nhân của quý khách với các bên thứ ba mà chúng tôi thuê để thay mặt chúng tôi thực hiện các dịch vụ như dịch vụ lưu trữ web, phân tích dữ liệu, để tiếp thị sản phẩm và dịch vụ của chúng tôi, để xử lý các giao dịch thẻ tín dụng và để cung cấp cho quý khách dịch vụ khách hàng. Tất cả các bên thứ ba này bắt buộc phải duy trì tính an toàn và bảo mật của Dữ Liệu Cá Nhân, và chỉ được xử lý Dữ Liệu Cá Nhân theo hướng dẫn của chúng tôi.</p>
				<p>
					Trong một số trường hợp, Best Price Vietnam có thể yêu cầu quý khách giao dịch trực tiếp với một bên thứ ba để nhận dịch vụ, hoặc khi quý khách sử dụng Website để đặt phòng khách sạn hay để nhận sản phẩm hoặc dịch vụ khác, chúng tôi có thể cung cấp Dữ Liệu Cá Nhân của quý khách cho khách sạn đó hoặc bên thứ ba có liên quan khác.
				</p>
				
				<p>
					Best Price Vietnam có thể tiết lộ Dữ Liệu Cá Nhân để bảo vệ bản thân chúng tôi trước các trách nhiệm pháp lý, để đáp ứng yêu cầu làm chứng ở toà án, đáp ứng các quy trình pháp lý, các yêu cầu pháp lý của nhân viên thi hành luật pháp, hoặc theo các yêu cầu khác nhằm tuân thủ luật pháp hiện hành, hoặc để đáp ứng yêu cầu của người mua liên quan đến bất kỳ việc mua bán, bàn giao, hoặc chuyển nhượng một phần hay toàn bộ cơ sở kinh doanh hoặc công ty của chúng tôi. 
				</p>
				
				<p>
					Chúng tôi cũng có thể tiết lộ Dữ Liệu Cá Nhân để thi hành hoặc áp dụng các điều khoản và điều kiện áp dụng cho sản phẩm và dịch vụ của chúng tôi, hoặc để bảo vệ quyền, tài sản hoặc sự an toàn của Best Price Vietnam, người dùng của chúng tôi hoặc đối tượng khác.
				</p>
				...
				<h5 class="bpv-color-title"><b>Chính Sách Của Chúng Tôi Về Các Cookie:</b></h5>
				<p>
				...
				<p>Cách hức Quý khách có thể truy cập hoặc thay đổi thông tin định danh cá nhân của mình:</p>
