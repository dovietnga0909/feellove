...
<div id="<?=$btn_popup?>_content" class="hide" style="line-height: normal;">
	...
	<div id="<?=$btn_popup?>_form" style="min-width:300px">
		<form id="tryitForm2" class="form-horizontal">
			<div class="margin-top-10">
				<label><?=lang('groupon_email')?>:</label><br>
				<input type="text" id="sign_in_email" class="form-control">
				<div style="padding: 5px 0;" class="hide bpv-color-warning er_sign_in_email">
					Bạn cần nhập đúng thông tin <b>[<?=lang('groupon_email')?>]</b>
				</div>
			</div>
			<div class="margin-top-10">
				<label><?=lang('sign_in_password')?>:</label><br>
				<input type="password" id="sign_in_password" class="form-control">
			</div>
			<div class="margin-top-10 clearfix">
				<div style="padding: 5px 0;" class="hide bpv-color-warning er_sign_in">
					<?=lang('sign_false')?>
				</div>
				<button onclick="send_sign_in_request(this)" data-loading-text="<?=lang('bpv_pro_code_loading')?>" id="<?=$btn_popup?>_hd" data-id="<?=$btn_popup?>" type="button" class="btn btn-bpv btn-book-now pull-right">
