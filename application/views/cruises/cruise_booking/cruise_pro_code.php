<p class="margin-bottom-20">*<?=lang('cruise_promotion_code_note')?>:</p>
...
<div class="row pro-code margin-bottom-10">
	...
	<div class="col-xs-2">
		<button type="button" class="btn btn-bpv btn-book-now" id="pro_use_2" style="display:none" onclick="use_pro_code(<?=CRUISE?>)" data-loading-text="<?=lang('bpv_pro_code_loading')?>">
			<?=lang('bpv_pro_use')?>
		</button>
	</div>
</div>