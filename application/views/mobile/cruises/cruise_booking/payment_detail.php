	...
	<div class="pro-code">
		...
		<div class="row">
			...
			<div class="col-xs-6 text-right">
				...
				?>
				<input type="hidden" value="<?=$nr_passengers?>" name="pro_nr_passengers" id="pro_nr_passengers">
				
				<button class="btn btn-bpv btn-book-now btn-sm margin-top-10" type="button" id="pro_use" style="display:none" onclick="use_pro_code(<?=CRUISE?>)" data-loading-text="<?=lang('bpv_pro_code_loading')?>">
					<?=lang('bpv_pro_use')?>
				</button>
			</div>
		</div>
