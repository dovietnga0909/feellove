...
?>
<div class="bpv-search" <?= !isset($search_visible) ? 'style="display: block;"' : ''?>>
		...
		<div class="row form-group">
			<div class="col-xs-12">
				...
				<select class="form-control" name="dep_id" id="dep_id">
    		        ...
    		        <option value="<?=$des['id']?>"  <?=set_select('dep_id', $des['id'], isset($search_criteria['dep_id']) && $tour_search_criteria['dep_id'] == $des['id'] ? true : false)?>><?=$des['name']?></option>
