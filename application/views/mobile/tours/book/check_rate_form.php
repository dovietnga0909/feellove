...
<div class="bpv-check-rate-form margin-bottom-20">
	...
	<div class="content pd-left-0 pd-right-0">
	
	<form id="check_rate_form" role="form" method="get" style="margin-bottom: 0">

			<input type="hidden" name="tour_id" value="<?=$tour['id']?>">
		    <input type="hidden" id="stay_night" value="<?=$tour['duration'] - 1?>">
		    
		    <?php if(!empty($tour_departures) && $tour['departure_type'] != 1):?>
