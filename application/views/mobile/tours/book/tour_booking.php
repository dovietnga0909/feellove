...
<div class="container">
	...
	<div class="booking-info margin-bottom-10">
	    ...
	    <div>
            <a href="<?=get_url(TOUR_DETAIL_PAGE, $tour, $check_rate_info)?>" class="pull-right">
              <i class="glyphicon glyphicon-edit"></i><?=lang('change_tour_booking')?>
            </a>
	    </div>
	</div>
...
<div class="container">
	...
	<div class="margin-top-20">
		<button type="submit" name="action" value="<?=ACTION_MAKE_BOOKING?>" class="btn btn-bpv btn-lg center-block"
			...
			<span class="icon icon-circle-arrow-right"></span>&nbsp;<?=lang('tour_complete_booking')?>
		</button>
	</div>
</div>
</form>