<style>
    .condition h3 { font-size: 13px; color: #F17B23; font-weight: bold; margin-bottom: 5px }
    .embed-responsive {
        display: block;
        height: 0;
        overflow: hidden;
...
<div class="bpv-list row margin-top-20">
    <h2 class="bpv-color-title">Giải nhất</h2>
    <div class="bpv-item">
		<img src="<?=get_static_resources('/media/news/grateful_week/Paradise.png')?>" class="pull-left">

		<div class="item-name">
			Du thuyền 5* Paradise Luxury
		</div>
		<span>cho 2 người trị giá <span class="bpv-price-from"><span>10.200.<small>000 đ</small></span></span></span>
	</div>
	<h2 class="bpv-color-title">Giải nhì</h2>
    <div class="bpv-item">
		<img src="<?=get_static_resources('/media/news/grateful_week/Pelican.png')?>" class="pull-left">

		<div class="item-name">
			Du thuyền 4* Pelican
		</div>
		<span>cho 2 người trị giá <span class="bpv-price-from"><span>6.500.<small>000 đ</small></span></span></span>
	</div>
	<h2 class="bpv-color-title">Giải ba</h2>
    <div class="bpv-item">
        <img src="<?=get_static_resources('/media/news/grateful_week/Paradise.png')?>" class="pull-left">

		<div class="item-name">
			Nghỉ dưỡng tại Paradise Suites 4*
		</div>
		<span>cho 2 người trị giá <span class="bpv-price-from"><span>1.800.<small>000 đ</small></span></span></span>
	</div>
</div>
<div class="container condition">
    ...
    <p><b class="step">Bước 3</b>: Hãy kêu gọi bạn bè và người thân của bạn like và share để có cơ hội trúng giải của Bestprice.
    <br><span class="bpv-color-price">1 Like = 1 điểm<br>1 Share = 2 điểm</span>
    </p>
    <h2 class="bpv-color-title" style="margin-top: 20px">Thể lệ "Mình đi chơi nhé"</h2>
    <h3>1.Đối tượng</h3>
    ...
    <p>1Like = 1 điểm<br>1Share = 2 điểm</p>
