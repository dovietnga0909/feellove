...
<?php if($flight_booking['is_unavailable'] || $flight_booking['is_timeout'] || isset($submit_status_nr)):?>
	<div class="container">
		...
		<?php
			...
			echo load_flight_booking_exception($search_criteria, $code, $is_mobile)
		?>
	</div>
<?php else:?>
      ...
      <div class="modal-footer">
      	<div class="row">
      		<div class="col-xs-6 col-xs-offset-3">
       			<button type="button" class="btn btn-bpv btn-block" data-dismiss="modal">OK</button>
       		</div>
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-dialog-room">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<form id="frm_passenger" name="frm_passenger" method="post" action="<?=get_url(FLIGHT_DETAIL_PAGE)?>">
