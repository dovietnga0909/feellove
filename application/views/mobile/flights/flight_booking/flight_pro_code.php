<p class="margin-bottom-20">*<?=lang('flight_promotion_code_note')?>:</p>
...
<div class="row pro-code margin-bottom-10">
	...
	<div class="col-xs-3">
		<input type="text" class="form-control" value="<?=!empty($flight_booking['promotion_code']) ? $flight_booking['promotion_code'] : ''?>" id="pro_code_2" placeholder="ABCXYZ..." style="font-weight:normal">
	</div>
	...
	<div class="col-xs-3">
		<button type="button" class="btn btn-bpv btn-book-now" id="pro_use_2" style="display:none" onclick="use_pro_code(<?=FLIGHT?>)" data-loading-text="<?=lang('bpv_pro_code_loading')?>">
			<?=lang('bpv_pro_use')?>
		</button>
	</div>
</div>