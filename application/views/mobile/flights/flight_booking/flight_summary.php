		...
		<div class="pro-code">
			...
			<div class="row">
				...
				<div class="col-xs-6 text-right">
					...
					<button class="btn btn-bpv btn-book-now btn-sm margin-top-10" type="button" id="pro_use" style="display:none" onclick="use_pro_code(<?=FLIGHT?>)" data-loading-text="<?=lang('bpv_pro_code_loading')?>">
						<?=lang('bpv_pro_use')?>
					</button>
				</div>
			</div>
