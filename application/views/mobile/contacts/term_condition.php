<div class="container term-lst">
	<h2 class="bpv-color-title">Điều khoản sử dụng và điều kiện với đặt phòng khách sạn</h2>
	<h5>Khi thực hiện đặt phòng khách sạn, quý khách cần phải thỏa mãn những điều kiện sau:</h5>
	
	<ul style="list-style: decimal;">
		<li><h5>Độ tuổi:</h5>
			<p>Quý khách phải từ 18 tuổi trở lên mới được phép tham gia đặt dịch vụ trên trang web.</p>
		</li>
		<li><h5>Thanh toán:</h5>
			<p>Quý khách thanh toán tiền đặt phòng trên trang web bằng 1 trong 3 cách sau:</p>
			<p>
				<b>Thẻ tín dụng hay thẻ ATM:</b> tại thời điểm quý khách đồng ý thanh toán tiền đặt phòng bằng thẻ tín dụng hay thẻ ATM,
				tổng chi phí sẽ được thông báo tại trang đặt . Đối với thẻ tín dụng, Dựa trên loại tiền tệ và quốc gia phát hành thẻ của
				quý khách, nhà cung cấp thẻ sẽ tính thêm chi phí tỉ giá và các mức phí khác với sự đồng ý của quý khách và nhà cung cấp
				thẻ; hoặc
			</p>
			<p>
				<b>Tiền mặt:</b> tại thời điểm đặt phòng, quý khách đồng ý đặt cọc tiền phòng cho chúng tôi trên trang web bằng cách gọi
				điện thoại hay chuyển khoản tới tài khoản của chúng tôi trên trang đặt phòng, bạn sẽ nhận được xác nhận đặt phòng; hay
				thanh toán bằng tiền mặt tại văn phòng Best Price Vietnam trong vòng 24h từ lúc thực hiện giao dịch.
			</p>
			<p>
		...
		<li>
			<h5>Xác nhận thông tin đặt phòng:</h5>
		...
		<li>
			<h5>Thực hiện thay đổi cho thông tin đặt phòng:</h5>
			<p>Chúng tôi sẽ cố gắng để hỗ trợ quý khách một cách tốt nhất, tuy nhiên chúng tôi không đảm bảo  mọi yêu cầu thay đổi sẽ
				được thực hiện. Xin xem những thông tin ghi chú sau:</p>
			<ul>
				<li>Những phòng đặt tại một số nhà cung cấp phòng, trong một thời điểm cụ thể, hoặc những loại phòng được đặt ở dạng đảm
					bảo là không thể hủy hoặc thay đổi, và những thông tin này được thể hiện trên trang đặt phòng hoặc chi tiết phòng của nhà
					cung cấp phòng (xem chính sách hủy phòng của khách sạn), quý vị nên xem thông tin này trước khi thực hiện việc đặt phòng.</li>
				<li>Ngoài ra, chúng tôi cũng áp dụng 1 phí quản lý  cho các yêu cầu  thay đổi đặt phòng /thông tin hủy phòng được chấp
					nhận, (phí cộng thêm ngoài mức phí huỷ phòng của nhà cung cấp phòng)</li>
				<li>Nếu việc thực hiện hủy phòng không thành công hoặc quý khách không thực hiện việc nhận phòng (check-in) đúng thời hạn
					so với đơn đặt phòng, quý khách sẽ phải thanh toán toàn bộ chi phí cho đơn đặt phòng đó.</li>
			</ul>
		</li>
		<li>
			<h5>Thông tin trang web:</h5>
			<p>Chúng tôi nỗ lực cam kết tất cả thông tin chính xác sẽ được hiển thị trên trang web, tuy nhiên xin lưu ý các thông tin
				cũng được chỉnh sửa từ nhà cung cấp dịch vụ, do đó chúng tôi không đảm bảo được những tất cả thông tin trên là chính xác
				hoàn toàn hoặc không có bất kỳ lỗi nào.Chúng tôi bảo lưu quyền thay đổi thông tin hiển thị trên trang web (bao gồm Điều
				khoản và Điều kiện này) bất kỳ thời điểm nào mà không phải báo trước.</p>
		</li>
		<li>
			<h5>Trách nhiệm:</h5>
			<p>Chúng tôi sẽ không chịu trách nhiệm với bất kỳ thiệt hại, mất mát, trách nhiệm, khiếu nại hoặc khoản phí nào (bao gồm
				những nguyên nhân sau: sự bất cẩn gây hậu quả trực tiếp hay gián tiếp gây ra) được phát sinh từ trang web chúng tôi liên
				quan đến những sản phẩm hay những dịch vụ được thực hiện trên trang này.</p>
			<p>Chúng tôi không bảo đảm hay là người đại diện cho những sản phẩm phòng ở hay dịch vụ nào trên trang web hoặc các trang
				kết nối. Ở đây trách nhiệm của chúng tôi chỉ cho phép thực hiện việc đặt phòng. Chúng tôi cam kết cho thuê phòng còn trống
				được cung cấp bởi các khách sạn thành viên (chúng tôi không chịu trách nhiệm với lý do không có phòng trống vì khách sạn đã
				cho thuê vượt quá số phòng).</p>
		</li>
		<li>
			<h5>Bản quyền:</h5>
		...
		<li>
			<h5>Chung:</h5>
			<p>Tất cả những điều khoản và điều kiện được công nhận bởi pháp luật Việt Nam. Chúng tôi nhận những thanh toán từ khách sạn
				thành viên từ việc cung cấp dịch vụ phòng đặt phòng của chúng tôi. Mọi thắc mắc liên hệ Công ty Best Price Vietnam.</p>
		</li>
	</ul>
	</p>


	<h2 class="bpv-color-title margin-top-20">Điều khoản và điều kiện với vé máy bay</h2>
	
	<p>
	<ul style="list-style: decimal;">
		<li>
			<h5>Điều kiện chung của dịch vụ điện tử</h5>
			<p>
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>Khách hàng đã mua vé nhưng không đến trong thời gian làm thủ tục để lên máy bay;</li>
						<li>Khách hàng đã mua vé nhưng không sử dụng vé và không thực hiện hành trình theo vé đã mua;</li>
		...
		<li>
			<h5>Mua vé máy bay và các dịch vụ khác</h5>
			<ul>
				<li>
					<p>Người sử dụng có thể mua vé máy bay theo hình thức ĐẶT CHỖ, YÊU CẦU ĐẶT VÉ cho bản thân Người sử dụng hoặc cho một bên thứ ba khi:</p>
					<ul>
