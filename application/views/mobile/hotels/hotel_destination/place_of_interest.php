...
<div class="bpv-box">
	<h3 class="box-heading no-margin"><?=lang('in_and_around') . ' ' . $city['name']?></h3>
	...
	<div class="tab-content bpv-in-and-around">
		...
		<div class="row margin-bottom-10">
			<div class="col-xs-12">
				<span class="icon icon-marker-p"></span>
		...
		<div class="row">
			<div class="des-bus col-xs-12">
				<span class="icon icon-marker-xs"></span>
