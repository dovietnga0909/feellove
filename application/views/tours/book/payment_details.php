<div class="bpv-total-payment margin-bottom-20">
	...
	<div class="pro-code">
		<div class="p-row clearfix" style="border-bottom:0">
			...
			<div class="text-right">
                <button class="btn btn-bpv btn-book-now btn-sm margin-top-10" id="pro_use" style="display:none" onclick="use_pro_code(<?=TOUR?>)" data-loading-text="<?=lang('bpv_pro_code_loading')?>">
					<?=lang('bpv_pro_use')?>
				</button>
			</div>
		</div>
