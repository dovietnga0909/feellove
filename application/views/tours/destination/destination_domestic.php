<div class="container-fluid no-padding margin-bottom-20" style="position: relative;">
	<div class="container">
		<ol class="breadcrumb margin-bottom-10">
			...
			<li class="active"><?=lang('label_domestic_tours')?></li>
		</ol>
		<h1 class="bpv-color-title margin-top-0" style="display:inline-block; white-space: nowrap;">
			...
			<?=lang('label_domestic_tours')?>
		</h1>
		<h3 class="bpv-color-title margin-top-0" style="display:inline-block;"> - <?=lang('marketing_domestic_tours')?></h3>
	</div>
    <?=$bpv_ads?>
			...
			<div>
				<?php foreach($categories as $ct):?>
					...
					<div class="category-col text-center">
						<a href="<?=get_url(TOUR_CATEGORY_DETAIL_PAGE, $ct);?>"><img class="margin-top-20 margin-bottom-20" src="<?=get_static_resources('images/categories/'.$ct['picture'])?>" /><br/>
