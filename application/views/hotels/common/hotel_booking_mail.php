...
<div style="width:800px;margin-bottom:10px">
    ...
    <p>Đơn đặt phòng khách sạn của quý khách đã được gửi tới <a href="<?=site_url()?>"><?=SITE_NAME?></a>. Nhân viên của chúng tôi sẽ tiến hành đặt phòng khách sạn và liên hệ tới quý khách trong khoảng thời gian sớm nhất.
