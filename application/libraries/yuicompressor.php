...
class YUICompressor
{
    ...
    function compress()
    {
        ...
        $os_x_lib_path = '';//export DYLD_LIBRARY_PATH=\"\"; /usr/bin/'; // for mac only
    	
    	// start with basic command
        $cmd = $os_x_lib_path."java -Xmx32m -jar " . escapeshellarg($this->JAR_PATH) . ' ' . escapeshellarg($file) . " --charset UTF-8";
